    ...
    <div class="container" style="margin-bottom: 50px;">
      <div class="row">
        <div class="col-md-6 col-md-offset-3">
          ...
          <?php if (canUpdateObjectByID('point-type', $excellence_id) || hasPermissionTo('create-category') ): ?>
            ...
            <form class="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group <?php xecho(isset($errors['type']) ? 'has-error' : ''); ?>">
                <input type="checkbox" id='choose_points' onchange="onChange('choose_points', 'point_selector')" class="form-check-input">
                <?php if (isset($errors['type'])): ?>
                  <span class="help-block"><?php xecho($errors['type']); ?></span>
                <?php endif; ?>
              ...
              <div id="user_selector" class="form-group <?php xecho(isset($errors['user_id']) ? 'has-error' : '') ?>">
                ...
                <select name="students[]" multiple="true">
                  <?php 
                    ...
                    if($result){
                      foreach($result as $key => $point_type) {
                      echo("<option value=" . $point_type['neptuncode'] . ">". $point_type['neptuncode'] . "</option>");
                      }
                    }
                    ?>
                  </select>
